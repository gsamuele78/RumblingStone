...
SRD URL pattern: `https://www.d20srd.org/srd/classes/[className].htm`

---

## Class Summary Table

| Class | HD | BAB | Good Saves | Skills/Level | Key Ability |
|---|---|---|---|---|---|
| Barbarian | d12 | Full | Fort | 4+INT | STR |
| Bard | d6 | ¾ | Ref, Will | 6+INT | CHA |
| Cleric | d8 | ¾ | Fort, Will | 2+INT | WIS |
| Druid | d8 | ¾ | Fort, Will | 4+INT | WIS |
| Fighter | d10 | Full | Fort | 2+INT | STR |
| Monk | d8 | ¾ | All three | 4+INT | WIS |
| Paladin | d10 | Full | Fort | 2+INT | CHA |
| Ranger | d8 | Full | Fort, Ref | 6+INT | DEX/STR |
| Rogue | d6 | ¾ | Ref | 8+INT | DEX |
| Sorcerer | d4 | ½ | Will | 2+INT | CHA |
| Wizard | d4 | ½ | Will | 2+INT | INT |

---

## Barbarian

**Special Features:** Fast movement (+10 ft), Illiteracy (starts), Rage, Uncanny Dodge (2nd), Trap Sense (3rd+), Improved Uncanny Dodge (5th), DR (7th+), Greater Rage (11th), Indomitable Will (14th), Tireless Rage (17th), Mighty Rage (20th)
...
Verified anchor rows (SRD Table: The Cleric / The Druid — same grid).
Slots shown WITHOUT the domain slot: a cleric adds **+1 per spell level** once
the two domains are chosen. The druid has no domain slot, so the row is the
druid's as written.

| Level | Spells/Day (0/1st/2nd/…) |
|---|---|
| 1 | 3/1 |
| 5 | 5/3/2/1 |
| 10 | 6/4/4/3/3/2 |
...
**Monk Speed bon**: +10 ft at 3rd and every 3 levels after (+60 ft at 18th); lost in armor or medium/heavy load
...
New SL every 2 levels (2nd-level spells at 4th, 9th-level at 18th).
...
**Specialist**: +1 spell slot per SL, school spells only; must
...
**XP Penalties**: If any class is 2+ levels ahead of others (except favored class), −20% XP penalty per mismatched pair.

**Favored Class**: Highest class; ignores for multiclass penalty. Humans: any 1 class designated. Half-elves: any 1. Other races: fixed (e.g., Halfling = Rogue, Dwarf = Fighter).
