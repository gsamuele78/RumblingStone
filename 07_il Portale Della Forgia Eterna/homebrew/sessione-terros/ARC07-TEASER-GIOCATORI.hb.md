<!-- GENERATO da scripts/build_booklet_html.py --format hb (ADR-0013).
     Manifest: ARC07-TEASER-GIOCATORI.manifest.json — i capitoli CITANO i master (ADR-0003).
...
### Il Tempio trattiene il fiato · sessione di lunedì

{{banner TEASER GIOCATORI}}

{{footnote
  Per i Custodi Eterni — Thorik, Tordek, Artemis (e per chi ascolta dal buio verde) · Valle di Channath, Flamerule 1372 DR · nessuno spoiler: solo ciò che avete vissuto, e un assaggio di ciò che vi aspetta
}}


\page

# ✉ Il cammino fin qui & L'Ultima Porta
