...
![Tavola I — Il borgo ai piedi del promontorio. La linea tratteggiata è il corridoio del vento: è l'indizio d'apertura.](tavole/abbazia-rotta-sicura-tavola-1.svg)

## Tavola II — Abbazia, livello 0 (chiesa e canonica)

![Tavola II — La canonica (10–17) è la parte accessibile di giorno; la chiesa (1–9) resta chiusa. **S** = botola sotto la lastra tombale.](tavole/abbazia-rotta-sicura-tavola-2.svg)

## Tavola III — Livello −1: cripta e blocco delle celle

![Tavola III — Le cinque celle (22) si aprono sul corridoio (21). Le grate sono in ferro, non ci sono serrature interne. **T** = fossa (scarica in 25).](tavole/abbazia-rotta-sicura-tavola-3.svg)

## Tavola IV — Livello −2: la Grotta della Consegna

![Tavola IV — La grotta si apre sul mare aperto (29). L'altare (27) è sommerso al colmo della marea: è il fatto tattico più importante dell'avventura.](tavole/abbazia-rotta-sicura-tavola-4.svg)
