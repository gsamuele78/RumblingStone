...
| **D13** | `RIPRESA-PR` | F4 · 4c | 🔵 **I Doni della resurrezione — alla revisione 4, e il DM ha gia' scelto due terzi.** La v2 era stata bocciata (pareggiava verso il basso e non toccava la Collana), la v3 l'ha rifatta come **trapianto artefatto→seme**, e il 2026-09-12 il DM ha scelto **un dono per PG** invece di una scala: **Tordek dona Ancoraggio della Montagna** e Hella ottiene **una RD inferiore**; **Artemis dona il Dono dell'Unita**, che le passa di mano. Su Thorik ha chiesto *«qualcosa di sensato»*, e la proposta e' **lo Smeraldo della Corona**: non il suo potere piu' forte, ma **quello per cui ha gia' pagato** — il −2 DES / +2 COS permanenti del 2026-07-31 li ha versati proprio per incastonarlo (eco E-07c). E' l'unico modo di fargli pagare due volte **senza un secondo malus di caratteristica**, e non collide con niente (il *Returning* e' gia' canone come temporaneo, la Senzienza bloccherebbe il risveglio di Aegis Fang). 🚪 **Il rifiuto adesso costa su due lati**, come chiesto: il seme resta dormiente **e l'artefatto reagisce** — Aegis Fang (Ego 14) **giudica** invece di obbedire, i Bracieri **tacciono una settimana**, l'Anello **si spegne 24 ore**. Tutte relazionali e reversibili, e il riempimento retroattivo in ARC-09 resta. 🔎 **Leggere la scheda di Hella invece di ricordarla ha corretto due numeri**: non ha **nessuna RD di base** (quindi quella di Tordek e' la sua unica, e nessun problema di non-cumulo → **RD 3/adamantino**, lo stesso numero che v1 prometteva, «inferiore» perche' solo l'adamantio taglia l'adamantio); e ha **vulnerabilita' al fuoco ×1,5**, che **nessuno dei tre doni scelti copre**. 🔴 **Cosa resta da decidere**: (1) si adotta la v4? (2) il grado III di Artemis, se lo si tiene come opzione, va avvertito in privato o tolto? (6) la vulnerabilita' al fuoco si accetta, si copre con la Doppia Fiamma al posto del Dono dell'Unita, o altrove? (7) **Tordek paga meno degli altri due**: gli si aggiunge Tremore del Forgiatore, o si accetta? |
