...
**Ultimo aggiornamento**: 2026-09-24, preparazione della serata del 2026-09-25 (ramo `claude/eager-fermat-ftrmzd`).
...
| 🙋 | **Al DM, dalla preparazione della serata**: sostituire la preghiera nanica di `DEF-3` §4 (è Tolkien alla lettera); correggere il pronome di Therysol in `state.md` §1 e §5; rigenerare i ritratti di Hella con la scheda-personaggio nuova; confermare i 102 pf di Durik | | regia della serata §7 | quattro righe, nessuna blocca la serata |
...
| ✅ | **F1.1/F1.2/F1.3** — mappare le norme su severità | [PIANO-MISURA-EDITORIALE](PIANO-MISURA-EDITORIALE-STANDARD.md) | *chiuso il 2026-09-21*: `punteggio_mqm --norme` → **12 norme su 41** (la mattina erano **4 su 39**, e il «~40» era scritto a mano e sbagliato; poi F2.7-F2.9 hanno collegato i rilevatori che esistevano e registrato due norme mai elencate). *(42 dal 2026-09-24: si è aggiunta la regola 3 degli echi, non misurata)* <!-- attesa: 42 norme; qui ne entrano 12 --> La severità è una colonna del registro — **1 critico · 15 maggiori · 20 minori** — e `misura_craft --discriminante` dice che i congegni-rumore sono **zero su 23** <!-- attesa: 0 congegni su 23 --> |
