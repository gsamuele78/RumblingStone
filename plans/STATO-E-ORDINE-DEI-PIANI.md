...
| ✅ | **La pagina stampabile della Collana dei Semi Eterni**, gemella di quella dell'Anello riforgiato, con l'immagine generata con Canva AI e confrontata con la scheda | C | `PG/Artefatti/ARTEFATTI-MATRICE-VERSIONI.md` §5 | fatto: due pagine A4. Restano indietro il master DM e l'handout `00_…` della Collana (Durik *evocato*, `[INFERRED]`): entrano nel lotto delle marcature di `PG/` |
