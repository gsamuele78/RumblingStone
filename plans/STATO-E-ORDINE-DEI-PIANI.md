...
| **D13** | `RIPRESA-PR` | F4 · 4c | 🔵 **I Doni della resurrezione — v4.** **Tordek dona Ancoraggio della Montagna** → Hella **RD 3/adamantino**; **Artemis dona il Dono dell'Unita** → **azione standard extra 1/g, anche a Durik**; **Thorik dona il +2 di deflessione della Corona** → **Lo Scudo del Custode** (1/g, immediata: Hella prende su di se' il danno di un alleato entro 9 m, **dimezzato**). Il criterio che ha scartato lo Smeraldo e' quello aggiunto dal DM: **il dono di Thorik deve accumularsi con quelli degli altri due**, e un terremoto 1/settimana non si somma a niente. 🔗 **La catena**: colpo da 40 su Artemis → dimezzato (20) → meno la RD di Tordek (17) → Artemis in piedi con l'azione extra. **L'unica combinazione in cui i tre poteri si moltiplicano invece di sommarsi.** 🔄 **E il DM ha migliorato il costo**: invece di −2 CA fissi, **−1 CA e ogni volta che Hella usa lo Scudo Thorik e' accelerato 3 round** — cosi' **l'anello si chiude**: lui da' la protezione, lei la usa per un altro, e la protezione gli torna come velocita', ogni volta, in combattimento. E' il principio del «seme restituisce» (§2.7) reso continuo. 🔴 **Ma l'aritmetica non torna**: 3 round/giorno di accelerazione valgono ≈ **3.600 mo** (gli stivali della velocita' costano 12.000 per 10 round/giorno) contro i ≈ **2.000** di un −1 di deflessione, e il **+1 CA di schivata dell'accelerazione cancella il −1** proprio nei round in cui incassa — **cosi' Thorik ci guadagna**, l'opposto di quel che il DM aveva chiesto. 🎯 **Taratura raccomandata (β)**: −1 CA + 3 round accelerato **poi affaticato** finche' non riposa. La spinta si paga subito dopo, com'e' sempre stato in 3.5, e **si autoregola**: piu' Hella protegge il party, piu' Thorik si brucia — e la volta dopo e' lei a poter scudare lui. 🔴 **Restano**: (1) quale dono per Thorik (A Scudo / B Linfa Sacra anti-non-morti / C Smeraldo)? (6) la **vulnerabilita' al fuoco ×1,5** di Hella resta scoperta — si accetta (🎯 io si')? (7) **Tordek paga meno degli altri due**: Tremore del Forgiatore in piu'? (8) la **taratura dell'Eco del Custode**: α, β o γ? |
