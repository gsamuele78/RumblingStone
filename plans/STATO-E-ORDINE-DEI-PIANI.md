...
**Ultimo aggiornamento**: 2026-09-25, dopo il merge delle #170-#174 (`eef36a9`) e il lotto 2f di CICLO-SESSIONE, il corredo della serata. Cosa ha chiuso la #169 e cosa ha lasciato aperto: §11. La storia delle scelte fuori stampa e il conto delle marcature aperte: §12.
...
| 🙋 | **Al DM, la D7 di CICLO-SESSIONE**: PyMuPDF fra le dipendenze di sviluppo, perché la misura del PDF giri anche in CI. Oggi in CI si dichiara saltata | | CICLO-SESSIONE §8 | una risposta: (a) sì o (b) no |
...
**16 aperte** · 45 chiuse — generato da `scripts/decisioni_dm.py --emit`, non si scrive a mano.
