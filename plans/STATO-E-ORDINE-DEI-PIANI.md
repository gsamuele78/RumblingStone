...
**7 aperte** · 12 chiuse — generato da `scripts/decisioni_dm.py --emit`, non si scrive a mano.
...
| **D3** | `PIPELINE-IBRIDE` | Lotto E | **Il ponte `llm_bridge.py` si costruisce, o ADR-0050 resta scritta e il codice aspetta?** La proposta è aspettare: con A e B chiusi il ciclo funziona a mano, e allora si vedrà se il ponte fa risparmiare davvero. Serve una risposta solo quando A e B sono chiusi |
