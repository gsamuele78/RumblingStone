...
**Ultimo aggiornamento**: 2026-09-25, dopo il merge delle #170-#174 (`eef36a9`) e della #176, e i lotti 2f e 2g di CICLO-SESSIONE: il corredo della serata, e l'apparato di lavoro fuori dalla stampa (ADR-0070). Cosa ha chiuso la #169 e cosa ha lasciato aperto: §11. La storia delle scelte fuori stampa e il conto delle marcature aperte: §12.
...
| 🙋 | **Al DM: le Benedizioni di Moradin hanno tre versioni.** Il PDF ne ha 3 (Vigore della Forgia 3d8+5), `DEF-2` §7 ne ha 4 (Vigore 3d8+10, più Forza della Montagna), `ARC07-HANDOUTS.md` ne elenca 6 diverse (Pelle di Pietra RD 3/adamantio). `DEF-3` dice «le 6 standard». Stasera si consegna il PDF, come dice la regia | K | `BenedizioniDiMoradin.pdf` · `DEF-2` §7 · `ARC07-HANDOUTS.md` handout 4 · `DEF-3` §8-bis | una risposta: quale lista vale, e con che numeri |
| 🙋 | **Al DM: la Corona a due gemme stampa «RD 5/epico [da confermare col DM: la fonte scrive «5/epic and evil»]»** sulla pagina del giocatore | K | `02_Corona_2_Gemme.html` e `_DM` | una risposta: 5/epico o 5/epico e male |
...
**15 aperte** · 46 chiuse — generato da `scripts/decisioni_dm.py --emit`, non si scrive a mano.
