...
| ✅ | **Le pagine stampabili della Collana dei Semi Eterni e di Durik**, giocatrice e DM, nella famiglia della Corona a 2 gemme; immagine della Collana generata con Canva AI e confrontata con la scheda | C | `PG/Artefatti/ARTEFATTI-MATRICE-VERSIONI.md` §5 | fatto: quattro pagine. Il lore del master DM e tre righe di `DEF-3` allineati (Durik sempre presente). Restano al DM tre punti in cui le fonti non coincidono, elencati nella pagina DM della Collana: quanti Treant insieme, i sacrifici descritti dalla skill di campagna, il vecchio handout `00_…` |
