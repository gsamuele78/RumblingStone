...
| [PIANO-REVISIONE-GLOBALE-2026-08](PIANO-REVISIONE-GLOBALE-2026-08.md) | Trasversale: audit su tre assi — **PRD/editoriale/pubblicazione**, **coerenza di flusso-storia-narrazione** (`[INFERRED]` inclusi), **ingegneria/ADR/testing/CI-CD** — con focus tavolo adulti | 🔵 **audit eseguito** (2026-08-05), esecuzione da autorizzare | ~8% (G0 di 12 lotti) | G1-G4 subito (nessuna decisione DM) · G5-G6 su decisione DM · G7-G9 infrastruttura · G10-G11 gated | G5/G6: decisioni DM · G3: sorte dei 13 asset Palio · G10: prima sessione reale · G11: intervista di ricostruzione |
...
- ⬜ _(G1 — **il più urgente**: `state.md` §1 colloca i PG dopo Hammerfist con Hella già risorta, mentre §0 marca l'Arco 08 `⬜ NON giocato` e la resurrezione come prossima. Il rimedio esiste già in §6, tabella a due tempi DM-confermata 2026-07-04: va esteso)_
