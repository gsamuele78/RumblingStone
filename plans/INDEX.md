...
- ⬜ _(E1 — immagini nel volume da stampa, monospazio embedded, margini speculari: sono bug, nessun gate)_
- ⬜ _(E2 — gate CI sulla stampa con `typst` a versione fissata + riprova dei tag PDF)_
- ⬜ _(E3 — schema del manifest booklet e parità dichiarata fra catena HTML e catena stampa)_
- ⬜ _(E4 — capolettera, riquadro laterale, segni di fine sezione, copertina in stampa, modalità carta bianca)_
- ⬜ _(E5 — tipografia embedded **anche** sulla catena HTML: ⚠️ tocca tutti i booklet della campagna, serve il via libera del DM)_
- ⬜ _(E6 — skill `rumblingstone-editoria` + scorecard aggiornata alla catena editoriale)_
- ⬜ _(E7 — rimandi cliccabili, indice analitico, imposizione A5-su-A4)_
- ⬜ _(E8 — **statblocchi strutturati**: blocco YAML nei master del Bestiario → `#statblocco()` in stampa, mostri in UVTT, verifica del GS. ⚠️ 161 schede: decisione DM, e se è no va chiuso come «non si fa»)_
