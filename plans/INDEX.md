...
- ⚠️ _(**CORREZIONE 2026-07-26**: la misura iniziale cercava solo RHoD e i toponimi FR. `campaign-history.md` dichiara **altre quattro fonti WotC** con numeri di pagina — *Expedition to Undermountain* (archi 02/03/04 + Tana dei Minotauri), *Underdark* (arco 01), *Out of the Abyss* (torre fungina = Neverlight Grove), lore FR (Aegis Fang = martello di Wulfgar). «Belkram» = località di Undermountain, **232 occorrenze in 49 file**, e dà il nome all'arco 04. Perimetro corretto: base pulita = **archi 07+08**, non 04-08)_
- ⬜ _(**archi 01-05 da scrivere**: soggetto consolidato in `SOGGETTO-DISCESA-UNDERDARK-ARCHI-01-05.md` — 6 domande di canone aperte prima di scrivere; proposta di partire dall'arco 03, il più ricco di materiale grezzo (29 file + una mappa SVG))_
