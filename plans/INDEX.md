...
| [PIANO-REVISIONE-GLOBALE-2026-08](PIANO-REVISIONE-GLOBALE-2026-08.md) | Trasversale: audit su tre assi — **PRD/editoriale/pubblicazione**, **coerenza di flusso-storia-narrazione** (`[INFERRED]` inclusi), **ingegneria/ADR/testing/CI-CD** — con focus tavolo adulti | 🟡 **in esecuzione**: G0 (audit), **G1** (due tempi), **G2** (deriva doc↔realtà) **G2-bis** (`state.yaml` + ADR-0017) **G2-ter** (pipeline sessione→stato) e **G2-quater** (prodotto vs partita) chiusi il 2026-08-05; **G3** (link e path) chiuso del tutto il 2026-08-09 | ~47% (8 di 17 lotti) | G3-G4 subito (nessuna decisione DM) · G5-G6 su decisione DM · G7-G9 infrastruttura · G10-G11 gated | G5/G6: decisioni DM (percorso critico) · G14: scheda di Thorik + INF-007 · G15: conferma echi · G10: prima sessione reale · G11: intervista di ricostruzione |
...
- ⬜ _(**G14** — nuovo, dal thread del 2026-08-09: le **schede dei PG** entrano nel repo come dati (Thorik è l'unico che non ce l'ha, ed è il motivo per cui il suo −2 DES è potuto sparire) + `validate_pg.py`, che pretende che ogni modificatore permanente dichiarato in un modulo giocato compaia sulla scheda del PG che l'ha subito. Passata su **tutti** gli artefatti vivi: i consolidamenti tengono i poteri e perdono i costi, ed è una classe di difetto, non un caso)_
- ⬜ _(**G15** — nuovo: passata sull'**Echo Ledger** e regola nuova — *un'eco che cambia autore si riscrive da zero o si annulla, mai si rinomina*. Gli echi diventano dati in `state.yaml` con autore e stato obbligatori, la tabella §7.E si genera)_
