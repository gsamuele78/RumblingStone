...
| [PIANO-LEVEL-DESIGN-E-INQUADRATURA](PIANO-LEVEL-DESIGN-E-INQUADRATURA-SCENICA.md) | Infrastruttura + contenuto: legenda **funzionale** fonte unica ([ADR-0014](adr/ADR-0014-legenda-funzionale-fonte-unica.md), = lotto E1 del PIANO-EDITOR) · linter di level design `lint_map_design.py` (M1-M9, advisory) · elevazione/zone/`design_intent` nel contratto · scheda-mappa · Modalità 4 blockout 3D→depth · ordine percettivo nel read-aloud | 🔵 **pianificato** (2026-07-26) | 0% | A1-A3 (dati) · B1-B5 (linter) · C1-C3 (mappe) · D1-D4 (inquadratura/prosa) — sequenza consigliata in §4 del piano | A1: decisione DM sulle 4 classificazioni divergenti (`⛰ 🏛 🗼 🗿`) · B5: corpus di calibrazione libero (mai RHoD, ADR-0005) · C2/D2: prova al tavolo · D3: GPU + Blender sulla macchina DM |
...
- ⬜ _(A3+A2 → B1+B4 → C2 → D1+D4 → B2/B3/B5 → D3 → C3: sequenza e stime in §4 del piano)_
