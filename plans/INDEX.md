...
| [PIANO-REVISIONE-GLOBALE-2026-08](PIANO-REVISIONE-GLOBALE-2026-08.md) | Trasversale: audit su tre assi — **PRD/editoriale/pubblicazione**, **coerenza di flusso-storia-narrazione** (`[INFERRED]` inclusi), **ingegneria/ADR/testing/CI-CD** — con focus tavolo adulti | 🟡 **in esecuzione**: G0 (audit) e **G1 (due tempi in `state.md`)** chiusi il 2026-08-05 | ~17% (2 di 12 lotti) | G2-G4 subito (nessuna decisione DM) · G5-G6 su decisione DM · G7-G9 infrastruttura · G10-G11 gated | G5/G6: decisioni DM · G3: sorte dei 13 asset Palio · G10: prima sessione reale · G11: intervista di ricostruzione |
...
- ⬜ _(G2-G4 — deriva doc↔realtà in `AGENTS.md` (3 cartelle documentate, 0 esistenti) · 17 link rotti + 4 path `/home/jfs/…` committati · inventario e ratchet dei 379 `[INFERRED]`)_
