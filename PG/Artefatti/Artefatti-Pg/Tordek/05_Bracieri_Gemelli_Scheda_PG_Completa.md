...
![Bracieri Gemelli - Stato Completo](bracieri_completi_v2.png)
...
La presenza della Terra stabilizza la furia del Fuoco, mentre il Fuoco infonde energia nella pietra immobile. Questi poteri sono sempre attivi.
...
*   **Vista della Galleria (Ex):**
    *   I tuoi occhi percepiscono le tensioni strutturali nella roccia.
    *   Entro 9m, noti automaticamente crepe, passaggi segreti in pietra o instabilità (+4 alle prove di Cercare pertinenti).
*   **Cammino nella Tempesta (Ex):**
    *   Sei inamovibile come la montagna.
    *   Non subisci penalità di movimento su terreno difficile (macerie, detriti).
    *   Ottieni un bonus di **+2** alle prove contrapposte o TS per resistere a Spingere, Sbilanciare o essere mosso forzatamente.
...
#### 2. Pugno Frana (Su) (3/Giorno)
*   **Azione:** Standard.
*   **Descrizione:** Colpisci con la forza di una valanga, trasmettendo l'energia cinetica attraverso il bersaglio e nel terreno.
*   **Effetto:**
    *   **Danni:** Colpo normale + **4d6 Contundenti** (ignora RD basata sulla durezza).
    *   **Impatto:** Il bersaglio deve superare **TS Riflessi CD 19** o cadere **Prono**.
    *   **Onda d'Urto:** Tutte le creature adiacenti al bersaglio (o nel quadretto colpito) devono superare una prova di **Equilibrio CD 15** o cadere **Prone** a causa della scossa sismica localizzata.

#### 3. Tremore del Forgiatore (Su) (1/Giorno)
*   **Azione:** Standard (Colpisci il terreno con entrambi i pugni).
*   **Descrizione:** Crei un terremoto localizzato che scuote le fondamenta stesse dell'area circostante.
*   **Effetto:**
    *   **Area:** Raggio di **6 m** centrato su di te.
    *   **Creature:** Tutte le creature a terra nell'area (eccetto te) devono superare **TS Riflessi CD 18**.
        *   *Fallimento:* Cadono **Prone** e subiscono **2d6 danni Contundenti**.
        *   *Successo:* Dimezza i danni e rimangono in piedi.
    *   **Strutture:** Infligge danni doppi a strutture di pietra o cristallo nell'area.

#### 4. Colpi del Fuoco (Su) (3/Giorno)
...
#### 5. Ancoraggio della Montagna (Su) (2/Giorno)
*   **Azione:** Immediata.
...
#### 6. Salto Fiammegiante (Su) (3/Giorno)
*   **Azione:** Movimento.
...
*   **Salto Orizzontale:** `(3 m × ⌊tiro/10⌋) + (3 m × Mod. Sag) + (1,5 m x ( per ogni 3m di velocità oltre i 12m))`

**3) Anello di Fuoco all’Arrivo**
*   **Area:** Raggio di 3 m.
*   **Danni:** **2d6 Fuoco** (Riflessi dimezza CD = 10 + 1/2 Livello + Mod. Sag).
...
### Martello di Fuoco e Pietra (Su) (Critico)
Una volta per round, quando metti a segno un **Critico Confermato** usando Attacco Poderoso, puoi spendere **1 Carica** per attivare uno degli effetti di impatto:
...
## Riepilogo Tattico (Cheat Sheet)

| Potere | Tipo | Azione | Usi | Effetto Sintetico |
| :--- | :---: | :---: | :---: | :--- |
| **Pugni di Magma** | (Su) | Swift | 3/gg | +Sag danni Fuoco, TS Tempra CD 18 o Infermo. |
| **Pugno Frana** | (Su) | Std | 3/gg | +4d6 Contundenti, TS Rif 19 o Prono + AoE Prono. |
| **Colpi del Fuoco** | (Su) | Std | 3/gg | +4d6 Fuoco, Spinta 1,5m, AoE 2d6 Fuoco. |
| **Tremore Forgiatore** | (Su) | Std | 1/gg | AoE 6m: 2d6 danni + Prono (Rif CD 18). |
