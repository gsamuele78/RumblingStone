...
**Key stats**: → `07_il Portale Della Forgia Eterna/_ARCHIVIO/Terros.md` (i numeri stanno li'; duplicarli qui creerebbe una seconda copia che diverge alla prima errata — ADR-0021).

**Faction**: elemental-earth | **Role**: boss | **Environment**: elemental-earth | **CR**: 15
**Source**: `07_il Portale Della Forgia Eterna/_ARCHIVIO/Terros.md` (statblocco d'arco, GS 15, golem di mithral / elementale antico; boss del Piano della Terra (ARC-07 P4))
