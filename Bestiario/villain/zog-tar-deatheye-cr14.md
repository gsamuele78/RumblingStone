...
**Source**: `07_il Portale Della Forgia Eterna/_ARCHIVIO/PortaleForgia-P5-DEFINITIVO-PARTE2.md` (statblocco d'arco, GS 14, Mezzo-Ogre/Orco Barbaro 10 / Guerriero 4)
**Status**: POINTER — NON duplicare lo statblock qui. Usare sempre il file d'arco.

## Summary

Comandante dell'orda nella battaglia antica di ~372 DR (ARC-07 P5), al fianco di Skullcrusher il Nero. E' il secondo boss di quell'atto.
...
Nella sintesi di `PortaleForgia-P6-INTEGRAZIONE-Completa.md` r.25 compare come «Zogtar (Barb 14)», senza apostrofo.
