# Grandmaster Rihan — Monk 14 [POINTER — statblocco nell'arco] [RIMANDO]
...
**Faction**: zhentarim | **Role**: melee-heavy | **Environment**: urban | **CR**: 14
**Source**: `09_Continuazione Arco Narrativo dopo Battaglia di Hammerfist/Arco-Post-Hammerfist-P2B-Torneo-Tordek-BATTLE-STATS-e-VILLAIN-ICONICI-Parte2.md` (statblocco d'arco, GS 14)
**Status**: POINTER — NON duplicare lo statblock qui. Usare sempre il file d'arco.

## Summary

Campione in carica del Torneo di Dauth.
