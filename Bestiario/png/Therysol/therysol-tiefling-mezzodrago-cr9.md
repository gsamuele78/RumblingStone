...
Therysol è un **PNG canonico** con scheda completa in `Bestiario/png/Therysol/Therysol/Therysol.md`
(145 righe, trasformazione + stats + roleplay). Classe canon: **Acolita (Adept) 6** convertita in
incantatore spontaneo Car-based. Alleata cacciatrice del Collezionista.

## Notes

Per stats complete vedere `Bestiario/png/Therysol/Therysol/Therysol.md`. NB: la mia derivazione iniziale (Sorc 7) NON è canon — la classe corretta è Acolita 6.
