...
**Attacks**: MW longsword +10 melee (1d8+3/19-20) | Longbow +6 ranged (1d8/x3)
**Full**: MW longsword +10/+5 (1d8+3)
**Abilities**: Str 14, Dex 12, Con 14, Int 10, Wis 10, Cha 8
**Feats**: Weapon Focus (longsword), Weapon Spec (longsword), Power Attack, Cleave, Leadership
**Skills**: Intimidate +7, Listen +3, Spot +3
**Special**: Darkvision 60 ft; Leadership bonus +1 morale to adj hobgoblin allies (10 ft).
**Gear**: Full plate, heavy steel shield, MW longsword, longbow + 20 arrows, potion of CLW x2, horn, whistle.
**Tactics**: Holds center of 10-man unit, calls formation changes, uses Cleave when surrounded.
**Notes**: 240 exemplaries in RHoD horde. Command 10-20 regular hobgoblin.
